...
obs_list = [[0, 580, 600, 20], [0, 0, 600, 20], [0, 0, 20, 600], [580, 0, 20, 600],
            ...
            [100, 540, 500, 10], [150, 500, 500, 10], [200, 460, 500, 10], [250, 420, 500, 10], [300, 380, 500, 10],
            [350, 340, 500, 10], [400, 300, 500, 10], [450, 260, 500, 10], [500, 220, 500, 10], [550, 180, 500, 10]]

obstacles = [classes.obstacle(rect, dis) for rect in obs_list]

paperwork = classes.paperwork([550, 100], dis)


def run_level(passed_before):
    player = classes.player(dis, [40, 540])
